...
astro_weight_columns = [
    result.WeightColumn(name='weight_marg', is_log=False, is_inverted=False)
    ]
...
posterior_quantiles = get_quantiles.get_p_of_eps_quantiles(
    ...
    save_path=f'quantiles/p_of_eps_quantiles_marg.csv'
    )
...
posterior_quantiles = get_quantiles.get_p_of_rho_quantiles(
    ...
    verbose=True, 
    max_num_samples=80000,
    save_path=f'quantiles/p_of_rho_quantiles_marg.csv'
    )
...
posterior_quantiles = get_quantiles.get_cs2_of_rho_quantiles(
    ...
    verbose=True, 
    max_num_samples=80000,
    save_path=f'quantiles/cs2_of_rho_quantiles_marg.csv'
    )
...
posterior_quantiles = get_quantiles.get_r_of_m_quantiles(
    ...
    verbose=True, 
    max_num_samples=80000,
    save_path=f'quantiles/r_of_m_quantiles_marg.csv'
    )
...
posterior_quantiles = get_quantiles.get_lambda_of_m_quantiles(
    ...
    verbose=True, 
    max_num_samples=80000,
    save_path=f'quantiles/lambda_of_m_quantiles_marg.csv'
    )