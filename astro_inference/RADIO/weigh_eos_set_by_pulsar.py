...
if __name__ == "__main__":
    pulsar_mass_sets = {"Fonseca_J0740": pd.read_csv("/home/isaac.legred/New_NICER/NoNSAnalysis/CalcSamples/Fonseca_J0740.csv"),
    ...
    for eos_set in [
        ...
        eos_posterior.samples.to_csv(f"../{eos_set}.csv", index=False)
