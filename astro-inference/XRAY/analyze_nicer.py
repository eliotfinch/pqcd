...
def marginalize_over_mr_samples(mr_samples, nicer_tag="j0740"):
    ...
    marginalizable_samples[f"weight_{nicer_tag}"] = np.exp(marginalizable_samples[f"logweight_{nicer_tag}"])
...
def weigh_eoss_by_nicer_samples(
    ...
    sample_weights = np.concatenate([
        weigh_by_density_estimate.weigh_mr_samples(mr_samples_set[["M", "R"]], nicer_data)
