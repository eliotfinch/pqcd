...
for X in [0.5, 2]:
    ...
    posterior_quantiles = get_quantiles.get_p_of_eps_quantiles(
        ...
        verbose=True, 
        max_num_samples=80000,
        save_path=f'quantiles/p_of_eps_quantiles_ntov_X{X}.csv'
        )
    ...
    posterior_quantiles = get_quantiles.get_p_of_rho_quantiles(
        ...
        verbose=True, 
        max_num_samples=80000,
        save_path=f'quantiles/p_of_rho_quantiles_ntov_X{X}.csv'
        )
    ...
    posterior_quantiles = get_quantiles.get_cs2_of_rho_quantiles(
        ...
        verbose=True, 
        max_num_samples=80000,
        save_path=f'quantiles/cs2_of_rho_quantiles_ntov_X{X}.csv'
        )
    ...
    posterior_quantiles = get_quantiles.get_r_of_m_quantiles(
        ...
        verbose=True, 
        max_num_samples=80000,
        save_path=f'quantiles/r_of_m_quantiles_ntov_X{X}.csv'
        )
    ...
    posterior_quantiles = get_quantiles.get_lambda_of_m_quantiles(
        ...
        verbose=True, 
        max_num_samples=80000,
        save_path=f'quantiles/lambda_of_m_quantiles_ntov_X{X}.csv'
        )