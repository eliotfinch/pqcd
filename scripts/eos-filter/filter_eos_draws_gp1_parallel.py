...
source_dir = Path('/home/eliot.finch/eos/pqcd/scripts/eos-draw/gp1-parallel')
destination_dir = Path(
    '/home/eliot.finch/eos/pqcd/data/eos-draws-modified/gp1/margagn'
)
...
for n_run in range(n_runs):
    ...
    for label in labels:
        ...
        for n in range(n_samp):
            source_path = (
                source_dir / f'{n_run}/{label}agn/DRAWmod1000-{int(n/1000):06}'
            )
            ...
            if pqcd.consistent_with_pqcd(eos, pqcd_region_dict):
                ...
                shutil.copy(
                    source_path / f'draw-gpr_{label}agn-{n:06}.csv',
                    destination_path /
