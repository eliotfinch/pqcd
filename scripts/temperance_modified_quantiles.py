...
default_eos_prior.eos_dir = '/Users/eliot/Documents/Research/EOS/pqcd/data/eos-draws-modified/12/margagn'
default_eos_prior.macro_dir = '/Users/eliot/Documents/Research/EOS/pqcd/data/eos-draws-modified/12/margagn'
...
posterior_quantiles = get_quantiles.get_p_of_eps_quantiles(
    ...
    verbose=True, 
    max_num_samples=1050,
    save_path=f'../data/eos-draws-modified/12/quantiles/p_of_eps_quantiles.csv'
    )
...
posterior_quantiles = get_quantiles.get_p_of_rho_quantiles(
    ...
    verbose=True, 
    max_num_samples=1050,
    save_path=f'../data/eos-draws-modified/12/quantiles/p_of_rho_quantiles.csv'
    )
...
posterior_quantiles = get_quantiles.get_cs2_of_rho_quantiles(
    ...
    verbose=True, 
    max_num_samples=1050,
    save_path=f'../data/eos-draws-modified/12/quantiles/cs2_of_rho_quantiles.csv'
    )
...
posterior_quantiles = get_quantiles.get_r_of_m_quantiles(
    ...
    verbose=True, 
    max_num_samples=1050,
    save_path=f'../data/eos-draws-modified/12/quantiles/r_of_m_quantiles.csv'
    )
...
posterior_quantiles = get_quantiles.get_lambda_of_m_quantiles(
    ...
    verbose=True, 
    max_num_samples=1050,
    save_path=f'../data/eos-draws-modified/12/quantiles/lambda_of_m_quantiles.csv'
    )