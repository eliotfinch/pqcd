...
# Save to disk
for n0 in n0_list:
    np.savetxt(f'quantities_at_fixed_n/pressure_{n0:02}nsat.dat', p0_dict[n0])
    np.savetxt(f'quantities_at_fixed_n/energy_density_{n0:02}nsat.dat', e0_dict[n0])

np.savetxt('quantities_at_ntov/pressure.dat', ptov_list)
np.savetxt('quantities_at_ntov/energy_density.dat', etov_list)